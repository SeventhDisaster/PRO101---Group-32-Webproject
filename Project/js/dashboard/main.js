...
function renderProjectTab () {
    ...
    for (var i = 0; i < projects.length; i++) {
        ...
        var temp = "<span onclick='redirectTo(\"board.html?project=" + i + "\")' style='width: 100%'>&nbsp;&nbsp; - " + projects[i].name + "</span> <div onclick='if(confirm(\"Are you sure you want to delete: \\\"" + projects[i].name + "\\\"?\")){projects.splice(" + i + ", 1); saveProjectChanges(); renderProjectTab(); renderTasks(getProjectsThisWeek()); renderNotifications()}' id='removeProject'>x</div>"
        var dom = newElem("div");
